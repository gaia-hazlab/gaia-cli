...
The basic approach is to:
    ...
    2. Normalize / munge to a uniform Xarray Vector Data Cube with [XVec](https://xvec.readthedocs.io)
    3. Save to [Zarr](https://zarr.readthedocs.io) in a temporary S3 bucket
    4. Now any group can easily load the timeseries, compare to rasters, use different libraries if they want, etc.
